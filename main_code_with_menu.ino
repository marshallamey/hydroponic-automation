...
enum operatingState {TOP, RIGHT, SENSORS, UTILITIES, DEF};
operatingState opState = DEF;                      //Defines states                        
int level = 1;
...
void setup() {                                        // *****SETUP FUNCTION***** //
  ...
  int time = millis();                                //Set time in LCD Display 
  time = millis() - time;
//  uint8_t i=0; 
}
...
void printData () {
  ...
  // *****FUNCTION TO PRINT DATA TO SERIAL MONITOR AND LCD***** //
...
uint8_t ReadButtons()
{
  ...
  return buttons;
                                  ...
                                  // Pause before displaying more information
//
